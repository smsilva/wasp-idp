# 00 — Tenancy Models (silo, pool, bridge)
...
siloado está em [`01-account-per-tenant.md`](01-account-per-tenant.md).
...
→ [`01-account-per-tenant.md`](01-account-per-tenant.md): quando o silo vira **uma conta AWS por
