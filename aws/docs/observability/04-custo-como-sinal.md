...
**Pilar WAF principal:** Cost Optimization (COST02/COST05 — custo observável e sob controle).
...
|---|---|
| **COST02-BP05** alertas de custo | Budgets por conta/tag pegam desvio antes da fatura |
| **COST05-BP01** monitorar custo continuamente | Anomaly Detection sobre padrão histórico |
...
→ [`05-mapa-crossplane.md`](05-mapa-crossplane.md): o que de observabilidade é provisionável e o
