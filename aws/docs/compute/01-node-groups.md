...
|---|---|
| **REL10-BP01** distribuir por AZ | node groups em ≥2 subnets privadas; `min` ≥ nº de AZs |
| **COST07-BP01** modelo de preço certo | spot para carga tolerante; on-demand só no baseline |
| **SEC05** sem exposição | nodes em subnet privada, sem IP público; saída via NAT/endpoints |
