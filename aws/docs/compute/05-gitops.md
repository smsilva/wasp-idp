...
|---|---|
| **OPS05** estado versionado | apps declaradas em Git; deploy = push, rollback = revert |
| **OPS06** reconciliação contínua | ArgoCD reverte drift automaticamente para o estado do Git |
