...
Ver `../security/07-crossplane-map.md`: **o Crossplane provisiona o IAM do que ele
...
- **Conta que hospeda este bootstrap:** `../accounts/03-provisioning.md` (a
  conta `network` deve existir antes).
- **Modelo de identidade e o próprio galinha-e-ovo:** `../security/04-workload-identity.md`
  e `../security/07-crossplane-map.md` — este domínio é o passo a passo executável do que
