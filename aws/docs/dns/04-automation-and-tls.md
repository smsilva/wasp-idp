...
| **[SEC08-BP01 — Implement secure key management](https://docs.aws.amazon.com/wellarchitected/latest/security-pillar/sec_protect_data_rest_key_mgmt.html)** | wildcard cert por subzona; apex no SAN quando preciso |
...
→ [`05-security.md`](05-security.md): IAM do Route53, DNSSEC e query logging.
