...
**Pilar WAF principal:** Security (SEC02 — identidades; SEC03 — permissões cross-account).
...
- **Role assumível por um terceiro/SaaS:** `ExternalId` é **obrigatório** (SEC03-BP08).
...
|---|---|
| **SEC02-BP02** credenciais temporárias | STS da conta de destino, sem IAM user duplicado |
| **SEC03-BP08** confused deputy | `ExternalId` obrigatório para roles assumíveis por terceiros |
| **SEC03-BP07** limitar acesso cross-account | trust policy escopada ao principal, não ao `root` da conta |
