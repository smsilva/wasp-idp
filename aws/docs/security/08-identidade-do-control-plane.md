# 08 — Identidade do Control Plane (quantas, e de que tipo)
...
O hop cross-account é o mesmo de [`02-roles-cross-account.md`](02-roles-cross-account.md) —
...
Ver `../accounts/00-estrategia-de-contas.md`, seção "Conta não tem região".
...
Já existe como guardrail baseline (`../accounts/02-guardrails-scp.md`), e é o eixo pelo qual as
OUs de tenant devem ser particionadas (`../tenancy/02-ou-por-geografia.md`). **Isto você deveria
...
[`02-roles-cross-account.md`](02-roles-cross-account.md); aqui o acréscimo é o
...
[`02-roles-cross-account.md`](02-roles-cross-account.md); para a trajetória do host do control
plane, [`04-identidade-de-workload.md`](04-identidade-de-workload.md).
