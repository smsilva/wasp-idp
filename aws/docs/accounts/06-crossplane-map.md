...
**Não confundir com o Crossplane do Control Plane (k3d) desta PoC** — seria uma instância/provider
...
1. Decidir se a Organization nasce numa conta **nova** (recomendado, ver
   `00-strategy.md` — "conta com residentes não deve virar gerência") ou se a
