...
**Pilar WAF principal:** Security (SEC01-BP03/BP04 — controles preventivos centralizados).
...
|---|---|
| **SEC01-BP03** controles preventivos automatizados | SCP nega na API, antes da ação acontecer |
| **SEC01-BP04** limitar acesso não-humano/root | Guardrail dedicado negando ações do usuário root |
| **REL/OPS** contenção de erro humano | Restrição de região evita "esqueci um recurso rodando em `sa-east-1`" |

## Próximo

→ [`03-provisionamento-de-contas.md`](03-provisionamento-de-contas.md): como criar as contas
de fato.