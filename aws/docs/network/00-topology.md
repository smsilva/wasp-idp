...
[`07-crossplane-map.md`](07-crossplane-map.md), que adia TGW/HubNetwork) é **não
...
daquele spoke. Detalhe em [`03-transit-gateway-isolation.md`](03-transit-gateway-isolation.md).
...
→ [`01-cidr-addressing.md`](01-cidr-addressing.md): sem um plano de CIDR sem
